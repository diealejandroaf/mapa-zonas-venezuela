...
// Hora referencial del sismo del 24 de junio de 2026 (hora de Venezuela, UTC-4).
const QUAKE = new Date('2026-06-24T16:42:00-04:00');
const hoursAfter = (h: number) => new Date(QUAKE.getTime() + h * 60 * 60 * 1000);

// ⚠️ DATOS DE DEMOSTRACIÓN. Los niveles de daño, estados de servicio, fuentes y
// refugios de abajo son ilustrativos para poder probar la app — NO son información
// verificada. Reemplazar con reportes de fuentes oficiales antes de publicar.
const zones = [
  {
    name: 'Yaracuy',
    slug: 'yaracuy',
      ...
      data: {
        ...
        reports: {
          create: reports.map((r) => ({
            ...r,
            status: 'published', // los datos sembrados se publican directo
          })),
        },
